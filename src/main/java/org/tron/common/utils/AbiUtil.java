...
//            Arrays.asList(new Uint256(BigInteger.valueOf(1)), new Utf8String("B"), new Utf8String("C"), new DynamicArray<>(
//                    new Uint256(BigInteger.ONE),
//                    new Uint256(BigInteger.valueOf(2)),
//                    new Uint256(BigInteger.valueOf(3)))),
//            Collections.<TypeReference<?>>emptyList());

        String expected = AbiUtil.parseMethod("testTransfer(address,uint256)", String.format("\"%s\",%d", "TSZcWmjrgfNpEjWC8yVVqTwHcjBttp16di", 10000L), false);
        System.out.println(expected);

        System.out.println(Numeric.toHexString(TronVegasApi.decodeFromBase58Check("TSZcWmjrgfNpEjWC8yVVqTwHcjBttp16di")));
        Function function = new Function("testTransfer",
                Arrays.asList(
                        new Address(Numeric.toHexString(TronVegasApi.decodeFromBase58Check("TSZcWmjrgfNpEjWC8yVVqTwHcjBttp16di"))),
//                        new DynamicBytes(TronVegasApi.decodeFromBase58Check("TSZcWmjrgfNpEjWC8yVVqTwHcjBttp16di")),
                        new Uint256(BigInteger.valueOf(10000L))),
                Collections.<TypeReference<?>>emptyList());

        String result = FunctionEncoder.encode(function);
        System.out.println("Function Output:");
        System.out.println(result);
//        System.out.println(Numeric.hexStringToByteArray(result) == Numeric.hexStringToByteArray(expected));
//    System.out.println(result.equals("0x" + parseMethod(method1, listString)));

//    Numeric.hexStringToByteArray(result);
